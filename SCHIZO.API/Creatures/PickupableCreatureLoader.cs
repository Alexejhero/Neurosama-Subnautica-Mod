    ...
    where TLoader : PickupableCreatureLoader<TData, TPrefab, TLoader>, new()
{
    ...
    private void LoadVariants()
    {
        new CreatureVariant(prefab.ModItem, prefab.CookedItem)
        {
            ...
            RecipeData = new RecipeData(new CraftData.Ingredient(prefab.ModItem, 1)),
...
#if SUBNAUTICA
            TechCategory = TechCategory.CookedFood,
#endif
        ...
        new CreatureVariant(prefab.ModItem, prefab.CuredItem)
        {
            ...
            RecipeData = new RecipeData(new CraftData.Ingredient(prefab.ModItem, 1), new CraftData.Ingredient(TechType.Salt, 1)),
            EdibleData = new EdibleData(prefab.FoodValueCooked, -3, false),
            FabricatorPath = CraftTreeHandler.Paths.FabricatorCuredFood,
#if SUBNAUTICA
            TechCategory = TechCategory.CuredFood,
#endif
