// Adapted from https://github.com/roboryantron/UnityEditorJunkie/tree/master/Assets/SearchableEnum/Code/Editor/
...
namespace PropertyDrawers
{
    ...
    public class SearchablePopup : PopupWindowContent
    {
        ...
        private class FilteredList
        {
            ...
            public FilteredList(string[] items, string[] itemNames)
            {
                allItems = items;
