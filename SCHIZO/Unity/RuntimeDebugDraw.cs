...
namespace RuntimeDebugDraw
{
	public static class Draw
	{
		...
		/// <param name="duration">How long the line stays visible for after the current frame.</param>
		/// <param name="depthTest">Whether the line should be obscured by objects closer to the camera.</param>
		public static void DrawLine(Vector3 start, Vector3 end, Color? color = null, float duration = 0, bool depthTest = true)
		{
