...
{
    private const int _rnd = 649248780;
    ...
    public static SCHIZO.Unity.Creatures.CreatureData Ermshark_ErmsharkData = _a.LoadAsset<SCHIZO.Unity.Creatures.CreatureData>("Assets/Ermshark/Ermshark data.asset");
