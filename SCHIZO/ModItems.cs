...
public static class ModItems
{
    ...
    public static readonly ModItem Tutel = new("tutel", "Tutel", "erm\n<size=75%>(Model by idk)</size>");
    public static readonly ModItem CookedTutel = new("cookedtutel", "Cooked Tutel", "erm\n<size=75%>(Model by w1n7er, icon by SADecsSs)</size>");
    public static readonly ModItem CuredTutel = new("curedtutel", "Cured Tutel", "erm\n<size=75%>(Model by w1n7er, icon by SADecsSs)</size>");
